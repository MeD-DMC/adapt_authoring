    ...
    database.getDatabase(function (err, db) {
      ...
      function coursePermission(courseId){
        db.retrieve('course', { _id: courseId }, { jsonOnly: true }, function (err, results){
          ...
          var filteredObject = _.pick(contentItem, '_extensions', '_id', '_courseId', '_accessibility');
          if (action === 'update' && contentItem && contentItem._extensions && contentItem._extensions._devtools && _.isEqual(filteredObject, contentItem)) {
